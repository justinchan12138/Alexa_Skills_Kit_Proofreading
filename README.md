...
You do not need an API key to use this application. The API I used (http://wiki.languagetool.org/public-http-api) is a free service. I also used AWS lambda to run the code. 
